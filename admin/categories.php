      ...
      <div class="modal-content">
        ...
        <form method="POST" enctype="multipart/form-data">
          <div class="modal-body">
            ...
            <div class="form-group">
              <label>Show Toppings</label>
              <select name="show_toppings" class="form-control">
            ...
            <div class="form-group">
              ...
              <select name="show_sizes" class="form-control">
                <option value="1">Yes</option>
                <option value="0">No</option>
              </select>
            </div>
          ...
          <tbody>
            ...
            ?>
              ...
              <tr>
                ...
                <td>
                  <?= $row['show_toppings'] == 1 ? 'Yes' : 'No' ?>
                </td>

                <td>
                  <?= $row['show_sizes'] == 1 ? 'Yes' : 'No' ?>
                </td>
                ...
                <td>
                  ...
                  <button
                    ...
                    data-show_toppings="<?= $row['show_toppings'] ?>"
                    data-show_sizes="<?= $row['show_sizes'] ?>">
...
<script>
  $(document).ready(function() {
    ...
    $('.editBtn').click(function() {
      ...
      $('#edit_show_toppings').val(
        $(this).data('show_toppings')
      );

      $('#edit_show_sizes').val(
        $(this).data('show_sizes')
      );
